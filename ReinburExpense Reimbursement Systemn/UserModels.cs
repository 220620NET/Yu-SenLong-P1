...
public class User
{
    public User(long ID, String userName, String passWord, Role role) //these are just placeholder attributes that does nothing more than the default getter and setters
    {
        this.ID = ID;
    ...
    public long ID {get;set;} //This should check for ID validity
